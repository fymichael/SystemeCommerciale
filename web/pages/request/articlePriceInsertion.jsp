                        ...
                        <div class="input-groups d-flex align-items-center">
                            <div class="form-group me-4">
                                ...
                                <select name="" id=""
                                    ...
                                    <option value="">Filtre a huile</option>
                                </select>
                            </div>
                            <div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <select name="supplier" id=""
                                                ...
                                                <option value="">Jumbo score</option>
                                                <option value="">Leader price </option>
                                            </select>
                                        </div>
                                        <div class="col-md-5 px-0">
                                            <input type="number" name="price"
                                                class="form-control form-control-sm"
                                                placeholder="30 000 AR">
                                        </div>
                                        <div class="col-md-2 px-3">
                                            <a href="" class="add-button"><i
